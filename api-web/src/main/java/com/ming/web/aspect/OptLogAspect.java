...
import com.ming.web.annotation.OptLog;
import com.ming.web.exception.BusinessException;
import com.ming.web.utils.IpUtils;
...
public class OptLogAspect {
     ...
     */
    @Pointcut("@annotation(com.ming.web.annotation.OptLog)")
    ...
    public void saveOptLog(JoinPoint joinPoint, Object result){
        ...
        if (Objects.isNull(apiAnnotation)){
            throw new BusinessException(ResultCodeEnum.SYSTEM_ERROR,"请在接口类上添加@Api注解");
        }
